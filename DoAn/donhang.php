...
include 'connect.php';
  ...
  if (isset($_GET['delbill']) && $_GET['delbill']==1) {
  	try {
  		
  	
  	$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	$stmt = $conn->prepare("DELETE FROM bill "); 
	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index1.php">Trang chủ</a><i class="fa fa-angle-right"></i>Đơn hàng</li>
				</ol>
...
<div class="agile-tables">
	<div class="w3l-table-info">
		...
		<a href="donhang.php?delbill=1"><button class="btn btn-default">Xóa hết đơn</button></a>
	</div>
...
<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu" >
			<li><a href="index1.php"><i class="fa fa-tachometer"></i> <span>Trang chủ</span><div class="clearfix"></div></a></li>
			
			
			<li id="menu-academico" ><a href="donhang.php"><i class="fa fa-envelope nav_icon"></i><span>Đơn hàng</span><div class="clearfix"></div></a></li>
			...
			<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Sản phẩm</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
				<ul id="menu-academico-sub" >
					<li id="menu-academico-avaliacoes" ><a href="sanpham.php">Xem sản phẩm</a></li>
