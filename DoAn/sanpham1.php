...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index1.php">Trang chủ</a><i class="fa fa-angle-right"></i>Xóa sản phẩm</li>
            </ol>
					...
					<div class="w3l-table-info">
					  ...
					  <div class="row">
					  	...
					  	<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							...
							<input type="submit"class="btn btn-default" name="del" value="Xóa sản phẩm">
							</form>
					  	</div>
					  	<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
