...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index1.php">Trang chủ</a><i class="fa fa-angle-right"></i>Lịch</li>
            </ol>
<!-- grids -->
				<div class="grids">
...
<div class="copyrights">
	 <p>© 2021 design by  <a href="http://w3layouts.com/" target="_blank">Huy Pham</a> </p>
</div>	
									...
									<!-- <li><a href="gallery.html"><i class="fa fa-picture-o" aria-hidden="true"></i><span>Gallery</span><div class="clearfix"></div></a></li> -->
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Sản phẩm</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="sanpham.php">Xem sản phẩm</a></li>
											...
											<li id="menu-academico-avaliacoes" ><a href="sanpham2.php">Cập nhập sản phẩm</a></li>
										  </ul>
										</li>
